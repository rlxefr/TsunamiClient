...
public class ColorPickerComponent extends SettingElement {
    ...
    public void mouseClicked(int mouseX, int mouseY, int button) {
        ...
        if (copy_focused) TsunamiClient.copy_color = getColorSetting().getColorObject();
        if (paste_focused)
            setColor(TsunamiClient.copy_color == null ? getColorSetting().getColorObject() : TsunamiClient.copy_color);
    }
