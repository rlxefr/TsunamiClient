...
public class ColorPickerElement extends AbstractElement {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        Render2DEngine.drawRect(matrixStack, x + 63f, y + 54f, 24, 7, TsunamiClient.copy_color);
    ...
    public void mouseClicked(int mouseX, int mouseY, int button) {
        ...
        else if (copyHovered) TsunamiClient.copy_color = getColorSetting().getColorObject();

        else if (pasteHovered) getColorSetting().setColor(TsunamiClient.copy_color.getRGB());
