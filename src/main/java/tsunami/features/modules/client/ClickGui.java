...
public class ClickGui extends Module {
    ...
    public final Setting<Integer> catHeight = new Setting<>("CategoryHeight", 200, 100, 720, v -> scrollMode.is(scrollModeEn.New));
    ...
    public final Setting<Integer> moduleWidth = new Setting<>("ModuleWidth", 80, 50, 200);
    public final Setting<Integer> moduleHeight = new Setting<>("ModuleHeight", 12, 8, 25);
    ...
    public void onEnable() {
        if(pauseBaritone.getValue() && !fullNullCheck() && TsunamiClient.baritone){
