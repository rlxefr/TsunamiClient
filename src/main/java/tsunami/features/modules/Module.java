...
import static tsunami.core.Managers.NOTIFICATION;
...
public abstract class Module {
    ...
    public void enable() {
        ...
        if (isOn()) TsunamiClient.EVENT_BUS.subscribe(this);
    ...
    public void disable() {
        try {
            TsunamiClient.EVENT_BUS.unsubscribe(this);
        ...
        LOGGER.info("[Tsunami] disabled {}", getName());
    ...
    public static class Category {
        ...
        public static final Category DONUT = new Category("Donut");
        public static final Category HUD = new Category("HUD");
        public static final Category NONE = new Category("NONE", true); // Hidden category
        ...
        // Private constructor for hidden categories
        ...
        // Return ALL categories (including hidden ones) - use sparingly
        public static Collection<Category> getAllCategories() {
            return CATEGORIES.values();
        }

        // Main method to get categories for display - ONLY visible ones
        public static Collection<Category> values() {
            return CATEGORIES.values().stream()
                    .filter(category -> !category.isHidden())
                    .collect(ArrayList::new, (list, category) -> list.add(category), ArrayList::addAll);
        }

        // Alias for values() - returns only visible categories
        public static Collection<Category> getDisplayCategories() {
            return values();
        }

        // Method to get only visible categories (same as values() now)
        public static Collection<Category> getVisibleCategories() {
            return values();
        }
