...
import static tsunami.utility.world.HoleUtility.validIndestructible;
import static tsunami.utility.world.HoleUtility.validTwoBlockIndestructible;

public class HoleAnchor extends Module {
    public HoleAnchor() {
        super("HoleAnchor", Category.NONE);
    }
