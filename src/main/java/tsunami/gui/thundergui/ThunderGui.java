...
import tsunami.gui.thundergui.components.*;
...
import static tsunami.utility.render.animation.AnimationUtility.fast;
...
public class ThunderGui extends Screen {
    ...
    public void renderGui(DrawContext context, int mouseX, int mouseY, float partialTicks) {
        ...
        FontRenderers.settings.drawString(context.getMatrices(), "recode v" + TsunamiClient.VERSION, main_posX + 91 - (FontRenderers.settings.getStringWidth("recode v" + TsunamiClient.VERSION)), main_posY + 30, ThunderHackGui.getColorByTheme(3).getRGB());
