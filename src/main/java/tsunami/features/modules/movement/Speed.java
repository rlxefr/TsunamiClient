...
import static tsunami.utility.player.MovementUtility.isMoving;

public class Speed extends Module {
    public Speed() {
        super("Speed", Category.NONE);
    }
    ...
    public void onSync(EventSync e) {
        ...
        if (mode.getValue() == Mode.MatrixJB) {
            ...
            if (MovementUtility.isMoving() && closeToGround && mc.player.fallDistance <= 0) {
                ...
                TsunamiClient.TICK_TIMER = matrixJBSpeed.getValue();
    ...
    public void modifyVelocity(EventPlayerTravel e) {
        if (mode.getValue() == Mode.GrimEntity && !e.isPre() && TsunamiClient.core.getSetBackTime() > 1000) {
        ...
        if ((mode.is(Mode.GrimEntity2) || mode.is(Mode.GrimCombo)) && !e.isPre() && TsunamiClient.core.getSetBackTime() > 1000 && MovementUtility.isMoving()) {
            int collisions = 0;
    ...
    public void onMove(EventMove event) {
        ...
        if (MovementUtility.isMoving()) {
            TsunamiClient.TICK_TIMER = useTimer.getValue() ? 1.088f : 1f;
